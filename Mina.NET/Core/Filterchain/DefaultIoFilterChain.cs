...
namespace Mina.Core.Filterchain
{
    ...
    {
        public readonly static AttributeKey SessionCreatedFuture = new AttributeKey(typeof(DefaultIOFilterChain),
            "connectFuture");
        ...
        private void CallNextExceptionCaught(IEntry<IOFilter, INextFilter> entry, IOSession session, Exception cause)
        {
            ...
            var future = session.RemoveAttribute(SessionCreatedFuture) as IConnectFuture;
            if (future == null)
            {
